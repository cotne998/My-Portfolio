        ...
        <div className="flex items-center gap-3 xl:gap-6">
          <a href="https://www.facebook.com/cotnikoo.cincadze/">
            <img
              ...
              alt="facebook icon"
              className="w-[20px] hover:scale-[1.2] transition-[0.2s]"
            />
          </a>
          <a href="https://github.com/cotne998">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20px"
              height="20px"
              viewBox="0 0 24 24"
              className="cursor-pointer hover:scale-[1.2] transition-[0.2s]"
              fill="none">
              <path
          ...
          <a href="https://www.linkedin.com/in/tsotne-tsintsadze-8745622b5/">
            <svg
              ...
              height="20px"
              viewBox="0 0 24 24"
              className="hover:scale-[1.2] transition-[0.2s]"
              fill="none">
              <path
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=cotnecincadze998@gmail.com&su=subject&body=text"
            className="flex items-center">
            <button
              title="cotnecincadze998@gmail.com"
              className="cursor-pointer">
              <img
                src="/assets/icon-gmail.svg"
                alt=""
                className="w-[25px] hover:scale-[1.2] transition-[0.2s]"
              />
            </button>
          </a>
        </div>
