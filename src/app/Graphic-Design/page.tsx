...
import data from "../../app/graphic-projects.json";
import "swiper/css";
...
export default function GraphicDesignPage() {
  ...
  return (
    <section className="p-7 flex flex-col xl:gap-5">
      <h1
        data-aos="zoom-in"
        className="text-[20px] mb-3 text-white text-center font-bold tracking-widest xl:text-[32px]">
        Graphic Design <span className="text-[#27DEBF]">Projects</span>
      </h1>
        ...
        <Swiper
          ...
          {data.map((item, idx) => (
            <SwiperSlide key={idx} className="h-full">
              <div className="cursor-grab active:cursor-grabbing hover:scale-[1.04] transition-[0.2s] flex flex-col justify-between gap-5 p-3 py-7 border-1 border-[#27dec000] rounded-[10px] bg-[#1e1e1e] shadow-[0_0_12px_2px_#27dec039] hover:shadow-[0_0_12px_8px_#27DEBF66]  xl:min-h-[550px] xl:p-8 xl:gap-8">
                ...
                <div className="flex justify-center items-center gap-3 xl:gap-7">
                  <Link
                    href={`/Graphic-Design/${item.route}`}
